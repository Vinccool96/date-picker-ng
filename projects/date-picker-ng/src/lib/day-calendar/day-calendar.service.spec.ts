...
describe('DayCalendarService', () => {
  ...
  it('should check the generateDaysIndexMap method', () => {
    ...
    expect(service.generateDaysIndexMap('mo')).toEqual({
      0: 'mo',
      1: 'tu',
      2: 'we',
      3: 'th',
    ...
    expect(service.generateDaysIndexMap('we')).toEqual({
      0: 'we',
      1: 'th',
      2: 'fr',
      3: 'sa',
  ...
  it('should check the generateWeekdays method', () => {
    ...
    expect(service.generateWeekdays('mo').map((d) => d.format('ddd'))).toEqual([
      'Mon',
      'Tue',
      'Wed',
      'Thu',
  ...
  it('should check isDateDisabled method', () => {
    ...
    expect(service.isDateDisabled(dayjsRef('12-10-2016', 'DD-MM-YYYY'), config)).toBe(false);
    expect(service.isDateDisabled(dayjsRef('13-10-2016', 'DD-MM-YYYY'), config)).toBe(false);

...
describe('DayTimeCalendarService', () => {
  ...
  it('should check the updateDay method', inject([DayTimeCalendarService], (service: DayTimeCalendarService) => {
  ...
  it('should check the updateTime method when time is before min', inject(
  ...
  it('should check the updateTime method when time is before max', inject(
    [DayTimeCalendarService],
    (service: DayTimeCalendarService) => {
      const daytime = dayjsRef('2011091313:12:11', COMBINED_FORMAT);
      const config: IDayCalendarConfigInternal = {
